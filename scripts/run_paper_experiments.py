...
PRESETS: dict[str, dict] = {
    ...
    "latent_triplet_uniformity_mask_curriculum": {
        "run_name": "latent_triplet_uniformity_mask_curriculum",
        "training_mode": "latent_triplet_uniformity",
        "anchor_mode": "predictor_corrupt",
        "triplet_weight": 0.5,
        "uniformity_weight": 0.5,
        ...
        "negative_mode": "scramble",
        "scramble_patch_size": 4,
        "corrupt_schedule": "block_curriculum",
        "patch_blur_ratio_min": 0.1,
        "mask_ratio": 0.3,
    },
    "latent_jepa_augment_uniformity": {
        "run_name": "latent_jepa_augment_uniformity",
        "training_mode": "latent_jepa_augment_uniformity",
        "anchor_mode": "predictor_corrupt",
        "triplet_weight": 0.5,
        "aug_align_weight": 1.0,
    ...
    "latent_jepa_augment_uniformity_vit": {
        "run_name": "latent_jepa_augment_uniformity_vit",
        "training_mode": "latent_jepa_augment_uniformity",
        "backbone": "vit",
        "vit_patch_size": 4,
        "vit_depth": 6,
    ...
    "latent_infonce_jepa_augment": {
        "run_name": "latent_infonce_jepa_augment",
        "training_mode": "latent_infonce_jepa_augment",
        "anchor_mode": "predictor_corrupt",
        "jepa_infonce_weight": 1.0,
        "aug_infonce_weight": 1.0,
        "infonce_temperature": 0.1,
        "align_weight": 0.0,
        "aug_align_weight": 0.0,
        "triplet_weight": 0.0,
        "uniformity_weight": 0.0,
        "corrupt_schedule": "block",
        "mask_ratio": 0.6,
    },
    "latent_infonce_jepa_augment_vit": {
        "run_name": "latent_infonce_jepa_augment_vit",
        "training_mode": "latent_infonce_jepa_augment",
        "backbone": "vit",
        "vit_patch_size": 4,
        "vit_depth": 6,
