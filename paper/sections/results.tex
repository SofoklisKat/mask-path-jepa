...
\begin{table}[t]
  \centering
  \caption{Proposed asymmetric hybrids vs.\ dual InfoNCE (SmallResNet, CIFAR-100).
  Values from checkpoint histories; SIGReg run continued beyond 100 epochs.}
  \label{tab:hybrid}
  \begin{tabular}{lcccr}
    \toprule
    Method & k-NN@20 & Linear & Epochs & Best@ \\
    \midrule
    Dual InfoNCE (baseline)     & 0.21--0.23 & 0.103 & 100 & ep90 \\
    InfoNCE + MSE + var + cov     & \textbf{0.193} & 0.154 & 100 & ep50 / ep100 \\
    InfoNCE + MSE + SIGReg        & 0.179 & \textbf{0.175} & 418 & ep90 / ep390 \\
    InfoNCE + SIGReg (ResNet-50)  & 0.095 & 0.115 & 62 & ep60 \\
    \bottomrule
  \end{tabular}
\end{table}
...
$\mathcal{L}_{\mathrm{mask}}\approx 0.24$ and $\mathcal{L}_{\mathrm{inv}}\approx 0.27$.
